...
//   // Safely get the first package item for details
//   // Assuming 'packageItems' is an array and we want the first item for quantity, pieceType, and dimensions
//   const firstPackageItem = data.packageItems && data.packageItems.length > 0 ? data.packageItems[0] : {};

//   // Determine the description to use in the table
//   // Prioritize itemDetails.description, then packageItems[0].description
//   const itemDescriptionForTable = data.itemDetails?.description || firstPackageItem.description;
...
//             {/* Table Data Row - Main Item/First Item */}
//             {/* Render this row if there's quantity, product, or a description */}
//             {(firstPackageItem.qty || data.product || itemDescriptionForTable) && (
//               <View style={styles.tableRow}>
//                 <Text style={[styles.tableCell, styles.tableCellFirst, styles.qtyCell]}>{firstPackageItem.qty}</Text>
//                 <Text style={[styles.tableCell, styles.pieceTypeCell]}>{firstPackageItem.pieceType || data.product}</Text> {/* Use pieceType if available, else product */}
//                 <Text style={[styles.tableCell, styles.descriptionCell]}>{itemDescriptionForTable}</Text>
//               </View>
//             )}

//             {/* Additional Rows for Dimensions and Weight - only show if data exists in the first package item */}
//             {firstPackageItem.lengthCm && (
//               <View style={styles.tableRow}>
//                 <Text style={[styles.tableCell, styles.tableCellFirst, styles.dimensionLabelCell]}><Text style={styles.detailLabel}>Length(cm)</Text></Text>
//                 <Text style={[styles.tableCell, styles.dimensionValueCell]}>{firstPackageItem.lengthCm}</Text>
//               </View>
//             )}
//             {firstPackageItem.widthCm && (
//               <View style={styles.tableRow}>
//                 <Text style={[styles.tableCell, styles.tableCellFirst, styles.dimensionLabelCell]}><Text style={styles.detailLabel}>Width(cm)</Text></Text>
//                 <Text style={[styles.tableCell, styles.dimensionValueCell]}>{firstPackageItem.widthCm}</Text>
//               </View>
//             )}
//             {firstPackageItem.heightCm && (
//               <View style={styles.tableRow}>
//                 <Text style={[styles.tableCell, styles.tableCellFirst, styles.dimensionLabelCell]}><Text style={styles.detailLabel}>Height(cm)</Text></Text>
//                 <Text style={[styles.tableCell, styles.dimensionValueCell]}>{firstPackageItem.heightCm}</Text>
//               </View>
//             )}
//             {firstPackageItem.weightKg && (
//               <View style={styles.tableRow}>
//                 <Text style={[styles.tableCell, styles.tableCellFirst, styles.dimensionLabelCell]}><Text style={styles.detailLabel}>Weight (kg)</Text></Text>
//                 <Text style={[styles.tableCell, styles.dimensionValueCell]}>{firstPackageItem.weightKg}</Text>
//               </View>
//             )}
...
//           <Text style={styles.weightText}>Total Volumetric Weight : {data.totalVolumetricWeight || '383580.07kg.'}</Text>
//           <Text style={styles.weightText}>Total Volume : {data.totalVolume || '1917.90cu. m.'}</Text>
//           <Text style={styles.weightText}>Total Actual Weight : {data.totalActualWeight || '1642.00kg.'}</Text>
//         </View>
//       </Page>
//     </Document>
//   );
